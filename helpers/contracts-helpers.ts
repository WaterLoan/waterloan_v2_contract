...
export const getParamPerNetwork = <T>(param: iParamsPerNetwork<T>, network: eNetwork) => {
  ...
  switch (network) {
    ...
    case eEthereumNetwork.tenderlyMain:
      return tenderlyMain;
    case eEthereumNetwork.coinexTest:
      return coinexTest;
    case eEthereumNetwork.coinex:
      return coinex;
  }
};

export const getParamPerPool = <T>({ proto, waterloan }: iParamsPerPool<T>, pool: AavePools) => {
  switch (pool) {
    case AavePools.proto:
      return proto;
    case AavePools.waterloan:
      return waterloan;
    default:
      return proto;
  }
