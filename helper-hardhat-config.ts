...
export const NETWORKS_RPC_URL: iParamsPerNetwork<string> = {
  ...
  [eEthereumNetwork.coinexTest]: 'https://testnet-rpc.coinex.net/',
  [eEthereumNetwork.coinex]: 'https://rpc.coinex.net/',
};
...
export const NETWORKS_DEFAULT_GAS: iParamsPerNetwork<number> = {
  ...
  [eEthereumNetwork.coinexTest]: 65 * GWEI,
  [eEthereumNetwork.coinex]: 65 * GWEI,
};

export const BLOCK_TO_FORK: iParamsPerNetwork<number | undefined> = {
  [eEthereumNetwork.main]: 12406069,
  [eEthereumNetwork.kovan]: undefined,
  [eEthereumNetwork.ropsten]: 10553000,
