...
export const MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  ...
  IFT: oneEther.multipliedBy('0.000003').toFixed(),
  WCET: oneEther.multipliedBy('0.000027').toFixed(),
  ONES: oneEther.multipliedBy('0.000537').toFixed(),
  USD: '5848466240000000',
};

export const WATERLOAN_MOCK_CHAINLINK_AGGREGATORS_PRICES = {
  AAVE: oneEther.multipliedBy('0.003620948469').toFixed(),
  BAT: oneEther.multipliedBy('0.00137893825230').toFixed(),
  BUSD: oneEther.multipliedBy('0.00736484').toFixed(),
  ENJ: oneEther.multipliedBy('0.00029560').toFixed(),
  ...
  STAKE: oneEther.multipliedBy('0.003620948469').toFixed(),
  xSUSHI: oneEther.multipliedBy('0.00913428586').toFixed(),
  USDC: oneEther.multipliedBy('0.000445').toFixed(),
  USDT: oneEther.multipliedBy('0.000462').toFixed(),
  DAI: oneEther.multipliedBy('0.0004645').toFixed(),
  IFT: oneEther.multipliedBy('0.000002092').toFixed(),
  WCET: oneEther.multipliedBy('0.00002707').toFixed(),
  ONES: oneEther.multipliedBy('0.0004782').toFixed(),
  USD: '216383403311',
};
