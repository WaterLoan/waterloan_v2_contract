...
export enum eContractid {
  ...
  TokenIncentivesController = 'TokenIncentivesController',
  WatIncentivesVault = 'WatIncentivesVault',
...
export type iWaterloanPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  | 'IFT'
  | 'ONES'
  | 'USDC'
...
export interface iEthereumParamsPerNetwork<T> {
  ...
  [eEthereumNetwork.coinexTest]: T;
  [eEthereumNetwork.coinex]: T;
}

export interface iParamsPerPool<T> {
  [AavePools.proto]: T;
  [AavePools.waterloan]: T;
}
...
export interface IWaterloanConfiguration extends ICommonConfiguration {
  ReservesConfig: iWaterloanPoolAssets<IReserveParams>;
}
